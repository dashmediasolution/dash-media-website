...
const faqs = [
  {
    question: "What’s the importance of effective web design for brands?",
    answer: "Effective web design is very important to create a strong first impression. It improves user experience and credibility. It also plays a prominent role in converting visitors into customers.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes, we offer web redesign services to enhance the look, performance, and SEO for better user engagement. With our support, redesigning lifts up to a phenomenal upgrade.",
  },
  {
    question: "How do I choose the right web design?",
    answer: "Analyze the competitor; identify their structure, color palette, and information they provide. Use these insights to find the right design that meets all the core qualities that you need.",
  },
  {
