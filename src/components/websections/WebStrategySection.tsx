...
const strategyData = [
  {
    ...
    description: "We conduct detailed research to understand clients’ industries and areas of opportunity to develop a strategy for the web design project.",
  ...
  },
  {
    ...
    description: "Our professional team designs a structure. Once it's approved by the client, development begins, including the optimizations for performance.",
  ...
  {
    id: "03",
    title: "Live & Post Support",
    description: "Before deploying the site, we install essential analytics and SEO toolkits to support traffic audits and management compliance.",
