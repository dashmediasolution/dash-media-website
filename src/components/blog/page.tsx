...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `${SITE_URL}/blog/${resolvedParams.category}`,
    },
    openGraph: {
      title: `${category} Articles & Insights | Dash Media Solutions`,
      description: `Read the latest ${category} news, tips, and strategies from Dash Media Solutions.`,
      url: `${SITE_URL}/blog/${resolvedParams.category}`,
...
export default async function CategoryBlogPage({ params, searchParams }: Props) {
  const resolvedParams = await params;
  const categorySlug = resolvedParams.category;
