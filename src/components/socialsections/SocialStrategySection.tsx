...
const strategyData = [
  {
    id: 1,
    title: "1. Strategy & Platform Selection",
    description: "We define your goals, identify your target audience, and select the social platforms where they are most active to ensure maximum impact.",
    image: "/images/stats.png",
    metrics: [
      { value: "95%", label: "Audience Targeting Precision", sub: "Reaching your ideal customers" },
      { value: "100%", label: "Goal-Oriented KPIs", sub: "Defining clear success metrics" },
    ],
  },
  {
    id: 2,
    title: "2. Content Creation & Calendaring",
    description: "Our team creates visually compelling and engaging content tailored to each platform, all planned out in a strategic content calendar.",
    image: "/images/stats.png",
    metrics: [
      { value: "30+", label: "Monthly Content Pieces", sub: "Across posts, stories, and reels" },
      { value: "2.5x", label: "Projected Engagement Rate", sub: "Compared to industry benchmarks" },
    ],
  },
  {
    id: 3,
    title: "3. Community Management & Growth",
    description: "We actively engage with your audience, respond to comments and messages, and run targeted campaigns to grow your follower base.",
    image: "/images/stats.png",
    metrics: [
      { value: "50%", label: "Increase in Follower Growth", sub: "Month-over-month average" },
      { value: "99%", label: "Response Rate", sub: "To all comments and messages" },
    ],
  },
  {
    id: 4,
    title: "4. Analytics & Reporting",
    description: "We track performance, analyze key metrics, and provide transparent monthly reports to refine the strategy for continuous improvement and ROI.",
    image: "/images/stats.png",
    metrics: [
      { value: "100%", label: "Data Transparency", sub: "With monthly performance reports" },
      { value: "25%", label: "Increase in Referral Traffic", sub: "From social to your website" },
    ],
  },
];

export function SocialStrategySection() {
  return (
            ...
            return (
              ...
              >
                ...
                {/* Metrics */}
                  <div
                  className={cn(
                    "grid grid-cols-1 gap-6 self-center text-left p-8 md:p-5",
