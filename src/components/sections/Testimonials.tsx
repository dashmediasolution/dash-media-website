...
const testimonials = [
    {
        ...
        name: "Rahul Patel",
        role: "Founder of E-commerce Business",
        review: "I loved how my new website looks. It’s creative and clear about my business and mentions all the information that any client needs to know to get started with us.",
    },
    {
    ...
    },
    {
        ...
        name: "Sarah Johnson",
        role: "Business Owner, Service-Based Company.",
        review: "I can’t recommend them enough! Dash Media has been a professional company to work with, providing outstanding service and delivering marketing solutions for social media and websites with unreal analytic results.",
    },
];
        ...
        <section className="py-20 bg-white">
            <div className="container mx-auto px-5 sm:px-20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 ">
                    ...
                    <div className="lg:col-span-8 bg-white rounded-[2rem] p-8 border-none flex flex-col justify-center min-h-[400px]">
