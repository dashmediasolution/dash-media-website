...
export function Testimonials() {
    ...
    return (
        <section className="py-15 md:py-20 lg:py-25 bg-blue-50">
            <div className="container mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-8 items-center">
                    ...
                    <div className="text-center md:text-left pl-3 sm:pl-0">
                        <h2 className="text-4xl lg:text-6xl font-regular font-heading text-primary tracking-tight">
                            What Our <span
                        ...
                        <p className="text-md sm:text-lg text-muted-foreground mt-6 leading-relaxed  p-5 md:p-0">
                    ...
                    <div>
                        <Carousel setApi={setApi} className="relative w-full">
                            <CarouselContent>
                                {testimonials.map((testimonial, index) => (
                                    ...
                                    >
                                        ...
                                        <p className="max-w-xl text-balance text-md lg:text-lg text-primary font-medium leading-relaxed">
                                            " {testimonial.review} "
                                        </p>
                            ...
                            <CarouselNext className="absolute  right-[6px]  top-1/2 -translate-y-1/2" />
                        </Carousel>
