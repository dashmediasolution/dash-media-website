...
const strategyData = [
  {
    ...
    description: "We offer comprehensive keyword research assistance to pinpoint terms and phrases that your target audience uses.",
  ...
  {
    id: "04",
    title: "Ad Copywriting and Optimization",
    description: "Our professionals work together to develop compelling ad copy and other promotional materials that capture users' attention.",
