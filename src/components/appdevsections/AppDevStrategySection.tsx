...
const strategyData = [
  {
    id: "01",
    title: "Enable Automation with Productivity",
    description: "We bring together expert developers to focus on creating app frameworks that engage users or streamline workflows.",
  ...
  },
  {
    ...
    description: "Our full-stack app development solution for businesses enhances customer experience and powers self-funded innovation.",
