...
const strategyData = [
  {
    id: 1,
    title: "1. Discovery & Prototyping",
    description: "We start by defining your app's core functionality, target audience, and creating interactive prototypes to visualize the end product.",
    image: "/images/stats.png",
    metrics: [
      { value: "100%", label: "Feature Set Defined", sub: "Before any code is written" },
      { value: "50+", label: "User-Flow Screens Mapped", sub: "Ensuring an intuitive UX" },
    ],
  },
  {
    id: 2,
    title: "2. UI/UX Design",
    description: "Our design team crafts a beautiful, modern, and user-friendly interface that aligns with your brand and provides an exceptional user experience.",
    image: "/images/stats.png",
    metrics: [
      { value: "4 ", label: " Weekly Design Mockups", sub: "Crafted in Figma" },
      { value: "98%", label: "User Satisfaction Score", sub: "Based on prototype testing" },
    ],
  },
  {
    id: 3,
    title: "3. Agile Development",
    description: "We build your app using agile methodologies, with regular sprints and updates. This ensures flexibility and transparency throughout the development process for both iOS and Android.",
    image: "/images/stats.png",
    metrics: [
      { value: "2", label: " Weekly Development Sprints", sub: "For rapid, iterative progress" },
      { value: "100%", label: "Native Performance", sub: "Optimized for iOS & Android" },
    ],
  },
  {
    id: 4,
    title: "4. Testing & Deployment",
    description: "Rigorous testing across multiple devices guarantees a bug-free launch. We handle the entire app store submission process for a seamless deployment.",
    image: "/images/stats.png",
    metrics: [
      { value: "500+", label: "QA Tests Performed", sub: "Ensuring stability and performance" },
      { value: "100%", label: "App Store Guideline Compliance", sub: "For smooth submission" },
    ],
  },
];

export function AppDevStrategySection() {
  return (
    <section className="pt-30 lg:pt-35 lg:pb-5 bg-gradient-to-b from-blue-50 to-gray-50" aria-labelledby="strategy-heading">
