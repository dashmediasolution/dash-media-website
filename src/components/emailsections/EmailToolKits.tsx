...
const toolkitLogos = [
  { name: "active-campaign", src: "/logos/email/activecampaign.png" },
  { name: "mailchimp", src: "/logos/email/mailchimp-email.png" },
  { name: "line-lite", src: "/logos/email/linelite.png" },
];

export function EmailToolkits() {
  return (
