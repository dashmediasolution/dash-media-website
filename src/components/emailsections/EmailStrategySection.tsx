...
const strategyData = [
  {
    id: 1,
    title: "1. List Building & Segmentation",
    description: "We start by implementing strategies to grow your email list with qualified leads and segmenting your audience for personalized messaging.",
    image: "/images/stats.png",
    metrics: [
      { value: "25%", label: "Increase in Subscriber Growth", sub: "Month-over-month average" },
      { value: "5+", label: "Audience Segments Created", sub: "For hyper-targeted campaigns" },
    ],
  },
  {
    id: 2,
    title: "2. Campaign & Automation Design",
    description: "Our team designs compelling email campaigns and automated workflows (like welcome series and abandoned cart reminders) to nurture leads.",
    image: "/images/stats.png",
    metrics: [
      { value: "15%", label: "Higher Open Rates", sub: "Compared to industry average" },
      { value: "30%", label: "Increase in Click-Through Rate", sub: "From automated workflows" },
    ],
  },
  {
    id: 3,
    title: "3. Content & Copywriting",
    description: "We write persuasive copy and create visually appealing email templates that capture attention and drive your subscribers to action.",
    image: "/images/stats.png",
    metrics: [
      { value: "2x", label: "Higher Engagement", sub: "On emails with custom designs" },
      { value: "99%", label: "Brand Voice Consistency", sub: "Across all campaigns" },
    ],
  },
  {
    id: 4,
    title: "4. A/B Testing & Optimization",
    description: "We continuously test subject lines, content, and send times to optimize your campaigns, ensuring we achieve the best possible results and ROI.",
    image: "/images/stats.png",
    metrics: [
      { value: "10%", label: "Increase in Conversion Rate", sub: "From A/B testing winners" },
      { value: "100%", label: "Performance Reporting", sub: "With actionable insights" },
    ],
  },
];
  ...
  return (
    <section className="pt-30 md:pt-35 lg:pb-5 bg-gradient-to-b from-blue-50 to-gray-50" aria-labelledby="strategy-heading">
      <div className="container mx-auto">
        ...
        {/* Strategy Steps */}
        <div className="mt-10 md:mt-20 flex flex-col gap-10 lg:gap-20">
